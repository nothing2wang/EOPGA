...
void printUsage() {
    mexPrintf("z = TV1D_denoise_v2(y,lambda)\n");
...
void mexFunction( int nlhs, mxArray *plhs[], 
    ...
    output      = (datatype *)mxGetPr( plhs[OUT_X] );
    input       = (datatype *)mxGetPr( prhs[IN_X] );
    lambda      = (datatype)mxGetScalar( prhs[IN_LAMBDA] );
